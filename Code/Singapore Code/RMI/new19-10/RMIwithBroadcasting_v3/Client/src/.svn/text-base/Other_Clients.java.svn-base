...
public class Other_Clients {
    ...
    public Other_Clients() throws Exception {
        ...
        // get IP address of the specified subsystem
        getIP("NAV");
    }
    ...
    // SUBSYSTEM'S LOCAL IP ADDRESS IS SENT TO CC
    ...
    // METHOD TO BE CALLED BY EXTERNAL CLASS TO GET CC'S IP FOR RMI REGISTRY
    public String getCC_IP() {
        return CC_IP.getHostAddress();
    }

    // REMOTE METHOD TO REQUEST FOR IP OF SPECIFIED SUBSYSTEM FROM CC SERVER
