...
public interface NAVInterface extends Remote {
    ...
    */
    public boolean MovementRequest(rawobjects.NavRequest pNavigationRequestObject, UUID pMoveRequestUUID) throws RemoteException;
}
