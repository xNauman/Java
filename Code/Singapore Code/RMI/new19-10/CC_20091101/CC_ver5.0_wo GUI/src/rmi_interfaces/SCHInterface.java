...
public interface SCHInterface extends Remote {
	 ...
	 */
	boolean startUpSCH(int pSimulatorRunID) throws RemoteException;
	 ...
	 * @throws java.rmi.RemoteException
	 */
	boolean startSCH() throws RemoteException;
	 ...
	 * @throws java.rmi.RemoteException
	 */
	boolean stopSCH() throws RemoteException;
	 ...
	 * @param pRequestID Response relates to SCH request ID
	 * @param moveAccept Was this move accepted?
	 * @return If the message has been accepted by SCH
	 * @throws java.rmi.RemoteException
	 */
	boolean responseFromNav(java.util.UUID pRequestID, boolean moveAccept) throws RemoteException;
