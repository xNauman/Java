...
public class CC_Server extends UnicastRemoteObject implements RMI_Interface {
    ...
    public CC_Server() throws IOException {
        ...
        System.out.println("CC Server created.");
    }
    ...
    // CC TO BROADCAST ITS IP ADDRESS TO ALL SUBSYSTEMS
    ...
    // SEND ACKNOWLEDGEMENT DIRECTLY BACK TO SUBSYSTEM
    ...
    /* GET IP ADDRESS OF SPECIFIED SUBSYSTEM AND RETURN TO REQUESTING SUBSYSTEM */
