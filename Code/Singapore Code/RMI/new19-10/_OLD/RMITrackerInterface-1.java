...
public interface RMITrackerInterface extends Remote {
   ...
   public boolean moveBus(Object reqBus) throws java.rmi.RemoteException;
    ...
    public boolean updateTL(ReqEXTUpdTL reqTrafficLight) throws java.rmi.RemoteException;

    public boolean updateStop(ReqEXTUpdStop reqBusStop) throws java.rmi.RemoteException;
