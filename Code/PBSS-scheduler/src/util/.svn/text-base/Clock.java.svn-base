...
public class Clock {
	...
	private static int iSimTime_NAVDirect = 0 ;

	public static void setSimTime_NAVDirect(int t){
		iSimTime_NAVDirect = t;
	}
...
//	
	...
	public static int getSimTime_NAVDirect(){
		return iSimTime_NAVDirect;
	}
