...
public class SysConfig {
	...
	//If TRUE, allows the Console Input thread to run
	...
	//set the range that we'll check buses for (ie how close together buses's can be)
	private static int mCheckingRangeForBuses = 70;
	...
	/**
	 * get the radius of pixels that we'll check inside for bus checking. This sets how close
	 * a bus can get to another
	 * 
	 * @return int that is the number of pixels that we'll include in the radius checking
	 */
	public static int getCheckingRangeForBuses() {
		return mCheckingRangeForBuses;
	}
	
	/**
	 * Set the radius of pixels that we'll check inside for bus checking. This sets how close
	 * a bus can get to another
	 * 
	 */
	public static void setCheckingRangeForBuses(int pRange) {
		SysConfig.mCheckingRangeForBuses = pRange;
	}
