...
public class Calculation {
	...
	public static int calculateDistance(int pSourcePointX, int pSourcePointY, int pDestPointX, int pDestPointY) {
		...
		/* Diagonal Case: the (x,y) coordinates are different */
			...
			System.out.println("xDistance(Calculation.java) is "+ xDistance);
			System.out.println("yDistance(Calculation.java) is "+ yDistance);
			System.out.println("TotalDistance(Calculation.java) is "+ vDistance);
			vDistance = Math.round(vDistance);
			System.out.println("TotalDistanceRounded(Calculation.java) is "+ vDistance);
		}
