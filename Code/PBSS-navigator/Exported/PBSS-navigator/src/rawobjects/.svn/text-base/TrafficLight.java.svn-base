...
public class TrafficLight implements Serializable{
    private static final long serialVersionUID = -8562449491971286573L;
    private int MapID;
    ...
    private Vector<rawobjects.Traffic_Light_Angle> TLAngle;//one trafficlight contains 3or 4 trafficlight angle
	...
	public TrafficLight()
	{
        ...
        this.TLAngle = new Vector<rawobjects.Traffic_Light_Angle>();
	}
    ...
    public Vector<rawobjects.Traffic_Light_Angle> getTrafficLightAngle() {
        return TLAngle;
    }
    public void setTrafficLightAngle(Vector<rawobjects.Traffic_Light_Angle> angle){
        this.TLAngle = angle;
    }
