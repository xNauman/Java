...
public class Traffic_Light_Angle implements java.io.Serializable{

    private static final long serialVersionUID = -4136465465789776546L;
    private int AngleID,TrafficLightID;
    private int Direction;
    private double Angle;

    public Traffic_Light_Angle(int iAngleID,int iTrafficLightID,int pDirection,double pAngle ){
        setAngleID(iAngleID);
