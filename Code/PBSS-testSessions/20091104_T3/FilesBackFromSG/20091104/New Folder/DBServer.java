...
public interface DBServer extends Remote{
    ...
    public Vector<String> CMEgetListofMap() throws RemoteException,SQLException;
    ...
    public void updatePAX(rawobjects.Pax_Stat pax) throws RemoteException,SQLException;
    ...
    public  void updateTrafficLight(rawobjects.TrafficLight pTrafficLight) throws RemoteException,SQLException;

    public  void updateBUS(rawobjects.Bus pBus) throws RemoteException,SQLException;

    public  void updateBusStop(rawobjects.BusStop pBusStop) throws RemoteException,SQLException;
    ...
    public void SUsaveMapToDB(rawobjects.Map map) throws RemoteException,SQLException;
